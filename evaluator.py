...
res_path = 'results/resnet_1step/resnet_1subclass_'
csv_path = 'results/resnet_1step/'
method_name = 'resent_AGI1000_1subclass'
...
df.to_csv(csv_path + method_name)           

print("current deletion score: {}".format(sum(scores['del'])/len(scores['del'])))
print("current insertion score: {}".format(sum(scores['ins'])/len(scores['ins'])))
